...
class BasicCNN(nn.Module):
    ...
    def forward(self, batch):
        ...
        #batch = (self.fc2_normed(self.fc2(batch))) 
    ...
    def using_pytorch_weight_loss(self):
        ...
        scaled_weights = np.array([2.699801021,
                    39.38904899,
                    3.419313659,
                    2.635870112,
                    30.39121411,
        ...
        scaled_weights = torch.Tensor(scaled_weights)
        scaled_weights.required_grad = False
        scaled_weights = scaled_weights.to(computing_device)
        
#         criterion = nn.BCEWithLogitsLoss(pos_weight = weights)  Working, but low accuracy
        criterion = nn.BCEWithLogitsLoss(pos_weight = scaled_weights)
